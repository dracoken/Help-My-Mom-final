...
export default withIronSessionApiRoute(async (req, res) => {
    ...
    let query = { //is the query search that is used within the prisma search functions
        orderBy: {
            createdAt: "desc"
        },
        where: {
            AND: {
                status: {
                    in: [issueStatus.NEW, issueStatus.ASSIGNED, issueStatus.SOLVING, issueStatus.SOLVED]
                }
            }
        },
        include: 
